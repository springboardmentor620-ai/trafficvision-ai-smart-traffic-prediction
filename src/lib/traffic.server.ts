...
export async function buildReportPayload(kind: string) {
  const b = await buildBundle();
  switch (kind) {
    case "congestion":
      return { kind, generatedAt: b.generatedAt, rows: b.topCongested, hourly: b.hourly };
    case "vehicles":
      return { kind, generatedAt: b.generatedAt, mix: b.vehicleMix, roads: b.roads };
    case "roads":
      return { kind, generatedAt: b.generatedAt, roads: b.roads, accidents: b.accidents };
    case "model":
      return { kind, generatedAt: b.generatedAt, model: b.model, predictions: b.predictions };
    case "heatmap":
      return { kind, generatedAt: b.generatedAt, cells: b.heatCells, layers: b.heatLayers };
    default:
      return { kind, generatedAt: b.generatedAt, kpis: b.kpis, weekly: b.weekly, monthly: b.monthly };
  }
}
